...
export class ProfileScreen {
    ...
    render() {
        ...
        const profileContent = `
            ...
            <form id="profile-form" class="space-y-5">
                ...
                <div class="space-y-1 opacity-75 text-left">
        ...
        const layout = new Layout(this.containerId, this.currentUser, {
            onNavigate: (route) => {
                if (route === 'home') this.navigateHome();
                // other routes handled by app/layout
            },
        ...
        const finalHtml = `
            <div class="flex flex-col gap-6 max-w-2xl mx-auto">
                ...
                ${Card(profileContent)}
                ${Card(perfContent, "p-5")}
                ${Card(securityContent)}
    ...
    addEventListeners() {
        ...
        // Logout
        const logoutBtn = this.container.querySelector('#logout-btn-profile');
        if (logoutBtn) {
